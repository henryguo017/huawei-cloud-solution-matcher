...
def build_anti_hallucination() -> str:
    return (
        ...
        "严禁编造具体数值、客户名称或案例细节。\n"
        "3. 【来源引用（强制）】凡涉及具体方案、产品能力、数据、案例的要点，"
        "必须在句末标注其来源资料编号，格式为 [资料N]（N 为下方【相关资料】中该资料的编号）；"
        "若综合多份资料，标注全部涉及编号，如 [资料1][资料3]；可同时附『据《来源文件名》』增强可读性。\n"
        "4. 不得出现任何无法对应到某一 [资料N] 的具体数字或客户案例；资料无对应内容则写『需进一步核实』。\n"
    )
