...
- **知识库管理** — 支持向量知识库构建、统计、重建和清空，覆盖 17 个行业、170 份方案文档
...
│   ├── script.js                 # 主逻辑（SPA 路由、API 调用、DOM 操作、产品图谱）
...
| 行业 | 文档数 | 代表方案 |
| ---- | ------ | -------- |
| 工业互联网 | 5 | 工业互联网平台、IoT数据分析、智能工厂等 |
| 智慧医疗 | 5 | 区域医疗、互联网医院、医技数字化等 |
| 智慧教育 | 5 | 智慧校园、在线教育、智慧教室等 |
| 智慧交通 | 4 | 交通大数据、智慧机场、智慧港口等 |
| 智慧农业 | 4 | 农业物联网、精准农业、智慧畜牧等 |
| 智慧园区 | 4 | 园区大脑、智慧运营、智能安防等 |
| 智慧城市 | 4 | 城市大脑、政务大数据、城市治理等 |
| 智慧文旅 | 4 | 智慧景区、文旅大数据、数字文博等 |
| 智慧能源 | 4 | 智能电网、新能源、能源大数据等 |
| 智慧金融 | 4 | 金融云、智能风控、数字银行等 |
| 互联网 | 1 | 互联网行业解决方案 |
| 制造 | 1 | 智能制造解决方案 |
| 政务 | 1 | 政务云一网通解决方案 |
| 汽车 | 1 | 车联网平台解决方案 |
...
| 类别   | 竞品                                                         | 行业覆盖 |
| ------ | ------------------------------------------------------------ | -------- |
| 国内   | 阿里云 · 腾讯云 · 天翼云 · 移动云 · 联通云 · 字节跳动火山引擎 | 各10个行业 |
| 国际   | AWS · 微软 Azure · Google Cloud · Oracle Cloud                | 各10个行业 |
| 行业   | 西门子 · 施耐德电气                                         | 各10个行业 |
...
**知识库大幅扩充：**
- 竞品文档补齐至 12 家 × 10 行业 = 120 份（新增 37 份，覆盖 AWS/Google Cloud/Oracle Cloud/天翼云/火山引擎/Azure/施耐德/移动云/联通云/西门子缺失行业）
- 华为云方案新增 7 个行业：生物医药、零售、游戏、政务、汽车、互联网、制造
- 华为云方案从 40 份扩充至 50 份（新增 10 份，基于华为云官网真实页面内容）
- 知识库总计 170 份文档，向量库 276 个文档片段
- 所有竞品文档内容基于各厂商官网/白皮书真实信息，统一格式（公司概况→行业核心方案→竞争优势→客户案例→核心劣势）

### v20260531w (2026-05-31)

**重构：**
- 移除 3D 产品架构树形图弹窗功能（HTML/CSS/JS 全部清理）
- 产品图谱模块重构为独立产品矩阵（纯展示 + 详情查看，无高亮/联动）
