...
# 2026-08-26 收拢：实现迁至共享模块 api/sse_utils.py（经典与 Agent 路由共用）
...
async def ai_chat(
    ...
    try:
        ...
        usage_keywords = [
            ...
            # 2026-09-06 新增功能：PPT 导出 / Agent 工作台 / 通知 / 皮肤 / 快速体验 / 账号
            "PPT", "ppt", "幻灯片", "演示文稿", "导出PPT", "PPT导出",
            "工作台", "Agent对话", "Agent 对话", "Agent 工作台", "新对话", "重新生成",
            "预览抽屉", "方案预览", "归档对话", "对话归档", "重命名对话",
            "算价", "实时算价", "TCO", "报价计算", "成本计算",
            "技能包", "行业口径", "专家口径", "自检", "质量审查",
            "皮肤", "主题", "配色", "换肤", "主题切换",
            "钉钉", "飞书", "群通知", "群机器人", "消息通知", "通知绑定", "webhook",
            "语音输入", "麦克风", "语音",
            "快速体验", "体验按钮", "Demo", "demo", "演示案例",
            "忘记密码", "找回密码", "重置密码", "绑定邮箱", "换绑邮箱",
        ]
